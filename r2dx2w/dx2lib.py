#
# Dynamixel 2.6 Library v2.6
#                                       Last Edit '21 1/22
#   Copyright (c) 2005, 2021 BestTechnology CO.,LTD.
#
...
if ('mingw' in get_platform()) or ('win' in get_platform()):
  ...
  #_dx2lib = CDLL('./dx2lib.so.2.6')
  _dx2lib = CDLL('/home/ubuntu/ros2ws/src/r2dx2w/r2dx2w/dx2lib.so.2.6')
...
_dx2lib.DXL_ScanDevices.argtypes = [c_void_p]
_dx2lib.DXL_ScanDevices.restype  = c_int
def DXL_ScanDevices(dvid):
  return _dx2lib.DXL_ScanDevices(dvid)
